    ...
    try {
      ...
      const html = `
        ...
        <body>
          <div class="certificate">
            ...
            <div class="details">
              Category: ${certificate.course.category}<br>
              Duration: ${certificate.course.duration} hours<br>
              Completion Date: ${certificate.enrollment?.completedAt ? new Date(certificate.enrollment.completedAt).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' }) : new Date(certificate.issuedAt).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}
            </div>
            ...
            <div class="signature">
              <div class="signature-line">
                <div class="line"></div>
                <div>Instructor</div>
                <div>${certificate.course.instructor.firstName} ${certificate.course.instructor.lastName}</div>
              </div>
              <div class="signature-line">
                <div class="line"></div>
      ...
      return new NextResponse(html, {
        ...
        headers: {
          ...
          'Content-Disposition': `inline; filename="certificate-${certificate.id}.html"`,
        },
      })
    } catch (error) {
